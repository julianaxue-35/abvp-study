...
#
# Journal is deliberately NOT a filter. The study guide names 23 journals, but
# Juliana's call (Aug 2026) is that the off-list titles that reached these
# sheets are all shelter-medicine relevant and stay in scope.
EXAM_MAX_YEAR = 2025
